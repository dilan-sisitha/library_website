    ...
    <div class="box2">
      ...
      <form name="Registration" action="" method="post">
        ...
        <div class="login">
          ...
          <input class="form-control" type="text" name="contact" placeholder="Phone No" required="" id="phone" onclick="phonenumber()"> <br>
...
<script type="text/javascript">
  var inputtxt= document.getElementById("phone").innerHTML
